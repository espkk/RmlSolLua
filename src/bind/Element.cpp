...
namespace Rml::SolLua
{
	...
	namespace child
	{
		static auto getMaxChildren(Rml::Element& self)
		{
	...
	void bind_element(sol::state_view& lua)
	{
		...
		lua.new_usertype<Rml::Element>("Element", sol::no_constructor,
			...
			"AppendChild", [](Rml::Element& self, Rml::ElementPtr& e) -> Rml::Element* { return self.AppendChild(std::move(e)); },
			...
			"InsertBefore", [](Rml::Element& self, Rml::ElementPtr& element, Rml::Element* adjacent_element) -> Rml::Element* { return self.InsertBefore(std::move(element), adjacent_element); },
